          ...
          <div className={styles.navMenu}>
            ...
            <div className={`${styles.navItem} ${styles.dropdown}`}>
              ...
              <div className={styles.dropdownMenu}>
                <a
                  href="https://autup.s3.ap-southeast-1.amazonaws.com/autusecurities5setup.exe"
                  target="_blank"
      ...
      >
        ...
        <div className={styles.sidebarContent}>
          ...
          <div className={styles.sidebarMenu}>
            <Link
              href="/"
              className={`${styles.sidebarItem} ${pathname === "/" ? styles.active : ""}`}
            ...
            <div className={styles.sidebarDropdown}>
              ...
              >
                ...
                Tải phần mềm
                <span
                  className={`${styles.sidebarDropdownArrow} ${isDropdownOpen ? styles.rotated : ""}`}
                >
                  ▼
                </span>
              </div>
              <div
                className={`${styles.sidebarDropdownMenu} ${isDropdownOpen ? styles.open : ""}`}
              >
                <a
                  href="https://autup.s3.ap-southeast-1.amazonaws.com/autusecurities5setup.exe"
            ...
            {pathname !== "/rank" && (
              <button
                className={styles.sidebarHistoryButton}
                onClick={handleHistory}
              >
                <span className={styles.sidebarIcon}>📊</span>
                LỊCH SỬ
